...
namespace AdventOfCode
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int amountOfBagsThatCanContainAShinyGoldBag = bagMapping.Sum(a => ContainsRecursively(a, shinyGoldBag, bagMapping) ? 1 : 0);

            Console.WriteLine($"Amount of bags that can contain a shiny gold bag: {amountOfBagsThatCanContainAShinyGoldBag}");
        }
